                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <button class="btn btn-success add ms-2" type="button" id="excel">Excel export</button>
                                    <form action="{{ route('filter.excel.teacher') }}" method="post">
                                        @csrf
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <form action="{{ route('filter.view.teacher') }}">
